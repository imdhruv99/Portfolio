...
const SocialMedia = () => {
  return (
    <div className="social-container">
      <a href="https://github.com/imdhruv99" className="github social">
      ...
      <a href="mailto:dpdhruvprajapati@gmail.com" className="googleplus social">
        <FontAwesomeIcon icon={faGooglePlus} size="3x" />
      </a>

      <a href="https://imdhruv99.medium.com/" className="medium social">
        <FontAwesomeIcon icon={faMedium} size="3x" />
      </a>

      <a href="https://dev.to/imdhruv99" className="dev social">
